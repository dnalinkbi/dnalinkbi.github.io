...
![ObjectDetection-1](/assets/images/CV/ObjectDetection-1.png)
...
![ObjectDetection-2](/assets/images/CV/ObjectDetection-2.png)
...
![ObjectDetection-3](/assets/images/CV/ObjectDetection-3.png)
...
![ObjectDetection-4](/assets/images/CV/ObjectDetection-4.png){:width="50%"}{: .center}
...
![ObjectDetection-5](/assets/images/CV/ObjectDetection-5.png){:width="70%"}

> 예측을 했냐? P(positive) 안했냐? N(negative), 그 예측 결과가 실제값과 일치하냐? T(true) 일치하지 않느냐? F(false)

![ObjectDetection-6](/assets/images/CV/ObjectDetection-6.png)
...
![ObjectDetection-7](/assets/images/CV/ObjectDetection-7.png){:width="50%"}

![ObjectDetection-9](/assets/images/CV/ObjectDetection-9.png){:width="50%"}
...
![ObjectDetection-8](/assets/images/CV/ObjectDetection-8.png)
...
![ObjectDetection-10](/assets/images/CV/ObjectDetection-10.png){:width="26%"} ![ObjectDetection-11](/assets/images/CV/ObjectDetection-11.png){:width="30%"}
...
![RGB](/assets/images/CV/CherryBlossom.jpeg){:width="60%"}


<br>

![BGR](/assets/images/CV/CherryBlossom-BGR.png){:width="70%"}
